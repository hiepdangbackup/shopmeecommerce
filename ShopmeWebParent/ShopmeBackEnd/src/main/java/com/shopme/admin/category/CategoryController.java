...
public class CategoryController {
	...
	public String saveCategory(Category category, @RequestParam("fileImage") MultipartFile multipartFile,
		...
		ra.addFlashAttribute("message", "The category has been saved successful.");
	...
	public String deleteCategory(@PathVariable(name = "id") Integer id, Model model,
		...
		redirectAttributes.addFlashAttribute("message", "The category ID " + id + "has been deleted successful.");
		return "redirect:/categories";
	}
