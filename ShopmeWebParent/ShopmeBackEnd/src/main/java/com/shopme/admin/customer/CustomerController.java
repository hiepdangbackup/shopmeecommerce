...
public class CustomerController {
	...
	public String saveCustoemr(Customer customer, Model model, RedirectAttributes ra) {
	...
	public String deleteCustoemr(@PathVariable Integer id, RedirectAttributes ra) {
		
		try {
			service.delete(id);
			ra.addFlashAttribute("message", "The customer ID " + id + " has been deleted successfully");
		} catch (CustomerNotFoundException ex) {
			ra.addFlashAttribute("messag", ex.getMessage());
		}
