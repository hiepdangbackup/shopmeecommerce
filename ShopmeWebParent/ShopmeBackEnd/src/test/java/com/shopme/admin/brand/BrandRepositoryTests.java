...
public class BrandRepositoryTests {
	...
	public void testCreateBrand2() {
		...
		Category tablets = new Category(18);
	...
	public void testCreateBrand3() {
		...
		samsung.getCategories().add(new Category(19)); // category internal hard drive
	...
	public void testGetById() {
		Brand brand = repo.findById(18).get();
	...
	public void testUpdateName() {
		...
		Brand samsung = repo.findById(20).get();
